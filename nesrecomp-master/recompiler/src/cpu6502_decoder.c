...
const OpcodeEntry g_opcode_table[256] = {
    ...
    /* 0x83 */ {MN_SAX,     AM_INDX,  2, 6},      /* SAX (zp,X) */
    /* 0x84 */ {MN_STY,     AM_ZP,    2, 3},
    /* 0x85 */ {MN_STA,     AM_ZP,    2, 3},
    /* 0x86 */ {MN_STX,     AM_ZP,    2, 3},
    /* 0x87 */ {MN_SAX,     AM_ZP,    2, 3},      /* SAX zp */
    /* 0x88 */ {MN_DEY,     AM_IMP,   1, 2},
    /* 0x89 */ {MN_NOP,     AM_IMM,   2, 2},      /* DOP #imm (consumes operand byte) */
    ...
    /* 0x8F */ {MN_SAX,     AM_ABS,   3, 4},      /* SAX abs */
    ...
    /* 0x97 */ {MN_SAX,     AM_ZPY,   2, 4},      /* SAX zp,Y */
    ...
    /* 0xEB */ {MN_SBC,     AM_IMM,   2, 2},      /* SBC #imm (unofficial alias of $E9) */
